...
이번 문제는 전형적인 플로이드 워셜 문제입니다.

n의 개수가 플로이드 워셜 알고리즘으로 해결할 수 있을 정도로 작기 때문에 쉽게 문제를 풀 수 있었습니다.

이 문제를 풀때 주의해야 할 점은 시간내 도착할 수 있다는 것이 '이하'인지 '미만'인지 잘 정해야 한다는 점입니다.

시간내 도착이라고 했으니 '이하'로 정하면 됩니다.
